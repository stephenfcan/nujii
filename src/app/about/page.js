export default function AboutPage() {
  return (
    <div className="bg-[#D9C4B1] text-[#5A3628] flex flex-col items-center justify-center min-h-screen p-8 pb-20 gap-4 sm:p-20 pt-20 sm:pt-0 -mt-14">
      <h1 className="font-Mirage text-5xl pb-3">about nujii</h1>
      <p className="font-sans text-md md:text-lg text-center max-w-xl pb-3">
